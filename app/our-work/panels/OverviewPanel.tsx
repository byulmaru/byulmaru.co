    ...
    <>
      <div className="hero">
        ...
        <div className="hero-inner">
          <span className="hero-tag">For Developers · Project Introduction</span>
      ...
      <section className="ow-section tab-panel">
        <div className="container">
          <p className="sec-label">01 · Background</p>
          <h2 className="sec-title">페디버스가 뭔가요?</h2>
          ...
          <div className="analogy-box">
            <span className="analogy-tag">비유로 이해하기</span>
            <p className="analogy-p">
            ...
            <p className="analogy-p" style={{ marginBottom: 0 }}>
          ...
          <div className="diagram">
            <div className="server-node highlight">
              <div className="node-name">우리 서버</div>
            ...
            <div className="arrow-wrap">
              ...
              <span className="arrow-sub">팔로우·리포스트·댓글 모두 가능</span>
            </div>
            <div className="server-node">
              <div className="node-name">마스토돈 서버</div>
              <div className="node-desc">
                다른 팀이
                <br />
                운영하는 서버
            ...
            <div className="arrow-wrap">
              <div className="arrow-line"></div>
              <span className="arrow-sub">같은 ActivityPub 프로토콜</span>
            </div>
            <div className="server-node">
              <div className="node-name">미스키 서버</div>
              <div className="node-desc">
                또 다른
                <br />
                독립 서버
                ...
                {FEDIVERSE_COMPARE.map((row) => (
                  <tr key={row[0]}>
                    ...
                    {row.slice(1).map((cell, index) => {
                      const className =
                        typeof cell === 'string' ? undefined : 'yes' in cell ? 'yes' : 'no';
                      const content =
      ...
      <section className="ow-section">
        <div className="container">
          <p className="sec-label">02 · Why We Build</p>
          <h2 className="sec-title">왜 기존 소프트웨어를 쓰지 않고 직접 만드나요?</h2>
          <p className="sec-lead">
          ...
          <div className="main-reason-box">
            <p className="main-reason-label">Main Reason</p>
            <p className="main-reason-headline">
              &quot;어느 서버에 가입해야 하지?&quot;
              <br />
              분산형 SNS의 첫 번째 질문부터 일반인을 막습니다.
            </p>
            <p className="main-reason-body">
      ...
      <section className="ow-section">
        <div className="container">
          <p className="sec-label">03 · What We Build</p>
          <h2 className="sec-title">무엇을 만드나요?</h2>
          <p className="sec-lead">
          ...
          <div className="build-grid">
            {OVERVIEW_BUILD_FEATURES.map((feature) => (
              <div className="build-card" key={feature.title}>
                <div className="build-icon">{feature.icon}</div>
                <p className="build-title">{feature.title}</p>
                <p className="build-body">{feature.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="ow-section">
        <div className="container">
          <p className="sec-label">04 · Our Users</p>
          <h2 className="sec-title">누구를 위해 만드나요?</h2>
          <p className="sec-lead">
          ...
          <div className="user-row">
            <div className="user-card u1">
              <div className="user-head">
                <p className="user-name">🎨 동인 창작자</p>
                <p className="user-role">일러스트레이터 · 글 작가</p>
              </div>
            ...
            <div className="user-card u2">
              <div className="user-head">
                <p className="user-name">📖 동인 향유자</p>
                <p className="user-role">논바이너리 포함 · 소수자 비율 높음</p>
              </div>
              <div className="user-body">
                <p>
            ...
            <div className="user-card u3">
              <div className="user-head">
                <p className="user-name">🌐 연합우주 경험자</p>
                <p className="user-role">서버 운영 경험 · 현실적 판단형</p>
              </div>
              <div className="user-body">
                <p>
      ...
      <section className="ow-section">
        <div className="container">
          <p className="sec-label">05 · Technical Context</p>
          <h2 className="sec-title">기술적으로 어떤 도전인가요?</h2>
          <p className="sec-lead">
      ...
      <div className="survey-divider">
        <div className="container">
          <p className="survey-divider-label">Research Data</p>
          <p className="survey-divider-title">사용자 조사 데이터</p>
          <p className="survey-divider-sub">
      ...
      <section className="ow-section">
        <div className="container">
          <p className="sec-label">Step 1.1 · Design Challenge</p>
          <h2 className="sec-title">경험 공유 및 맥락 정리</h2>
          ...
          <div className="stat-row">
            {OVERVIEW_SURVEY_STATS.map(([label, value]) => (
              <span className="stat-chip" key={label}>
          ...
          <div className="insight-grid">
            <div className="insight-card">
              <p className="card-head">이탈 계기 — 트위터(X)에서 연합우주로</p>
            ...
            <div className="insight-card">
              <p className="card-head">현재 플래닛 이탈 이유</p>
              <p className="card-body">
            ...
            <div className="insight-card">
              <p className="card-head">주 사용 SNS 분포 (복수응답)</p>
              <p className="card-body">
            ...
            <div className="insight-card">
              <p className="card-head">타겟 사용자 특성</p>
              <p className="card-body">
      ...
      <section className="ow-section" style={{ borderBottom: 'none' }}>
        <div className="container">
          <p className="sec-label">Step 1.2 · Pain Point &amp; Needs</p>
          <h2 className="sec-title">핵심 불편함과 욕구</h2>
          <p className="sec-intro">
            ...
            <table className="pain-table">
              ...
              <tbody>
                {OVERVIEW_PAIN_POINTS.map((row) => (
                  <tr key={row.tag}>
                    <td>
                      <span className={`tag ${row.cls}`}>{row.tag}</span>
                    </td>
                    <td>{row.pain}</td>
                    <td>{row.need}</td>
