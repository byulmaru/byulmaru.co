  ...
  return (
    ...
    >
      <div className="container">
        <p className="sec-label">kosmo-docs · User Scenarios</p>
        <h2 className="sec-title">가입부터 연합, 탐색, 통합 피드까지의 핵심 여정</h2>
        ...
        <div className="journey-list">
          {journeys.map(([code, title, body]) => (
            <article className="journey-item" key={code}>
              <span className="journey-code">{code}</span>
              <div>
                <h3>{title}</h3>
                <p>{body}</p>
              </div>
