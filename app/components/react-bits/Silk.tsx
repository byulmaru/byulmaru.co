// React Bits Silk — https://github.com/DavidHDev/react-bits
// Original shader retained. Local changes: pause, DPR cap, and Canvas fallback.
// License: ./LICENSE.md
...
const Silk: React.FC<SilkProps> = ({
  ...
  // Three.js uniforms are mutable GPU inputs, not React state.
