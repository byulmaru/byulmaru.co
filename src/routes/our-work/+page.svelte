...
<section class="ow-section">
  <div class="container">
    ...
    <p class="sec-lead">
      개발을 시작하기 전에, 우리가 다루는 생태계를 이해하는 게 먼저예요. 생소한 개념이지만 비유로
      설명하면 금방 이해할 수 있어요.
    </p>
    ...
    <div class="analogy-box">
      ...
      <p class="analogy-p">
        ...
        <strong>ActivityPub</strong>이라는 공통 프로토콜로 연결된 분산 SNS 네트워크예요. 서로 다른
        서버에서 운영되지만, 마치 하나의 SNS처럼 팔로우·리포스트·댓글이 모두 가능합니다.
      </p>
...
<section class="ow-section">
  <div class="container">
    ...
    <p class="sec-lead">
      ActivityPub 프로토콜을 구현한 단문형 SNS 서버와 클라이언트를 처음부터 만듭니다. 현재 생각 중인
      피쳐들은 이렇습니다.
    </p>
  ...
  <div class="container">
    ...
    <div class="user-row">
      ...
      <div class="user-card u2">
        ...
        <div class="user-body">
          <p>
            <strong>핵심 불만:</strong> 좋아하는 장르 창작물 찾기 어려움. 혐오 발언 노출. 서버 선택 장벽.
          </p>
    ...
    <div class="callout-blue">
      <strong>가장 중요한 발견:</strong> 사용자들이 새 서비스로 오지 않는 1순위 이유는 기능 부족이
      아닙니다.
      <strong>"지인이 없기 때문"</strong>이에요. 트위터 팔로우 목록 연동, 지인 초대 시스템을 염두에
      두어야 합니다.
    </div>
  </div>
</section>
...
<section class="ow-section">
  <div class="container">
    ...
    <p class="sec-lead">
      ActivityPub 구현은 일반 API 서버 개발과 다른 점이 있어요. 합류 전에 알아두면 좋은 기술 맥락을
      정리했습니다.
    </p>

    <div class="stack-note">
      <strong>ActivityPub이란?</strong> W3C 표준 프로토콜로, 분산 소셜 네트워크 간의 상호운용성을 정의해요.
      Actor(사용자), Object(게시물), Activity(팔로우·좋아요·게시 등의 행동)로 이루어진 JSON-LD 기반 메시지를
      서버 간에 주고받는 방식입니다. 마스토돈·미스키가 이 프로토콜을 구현해 서로 통신하고 있어요.
    </div>
...
<section class="ow-section">
  <div class="container">
    ...
    <p class="sec-intro">
      우리가 풀고자 하는 문제가 왜 발생했는지, 사용자들은 어떤 상황에 놓여 있는지 데이터 기반으로
      공유합니다.
    </p>
    ...
    <div class="callout-yellow">
      ...
      <strong>여러 연합우주 서비스를 동시 병용</strong>하고 있다. 단일 서비스로 완전히 정착하지 못한
      분산 상태다.
    </div>
    ...
    <div class="insight-grid">
      ...
      <div class="insight-card">
        ...
        <p class="card-body">
          ...
          대부분이 2~3개 플랫폼을 병용. "동인 창작"은 X에, "일상/교류"는 연합우주에 쪼개서 사용하는 패턴이
          뚜렷하다.
        </p>
      </div>
      <div class="insight-card">
        ...
        <p class="card-body">
          ...
          기대한다. 창작물 노출 대상은 "<strong>같은 취향의 사람들</strong>"이 압도적 다수 — 불특정
          대중이 아닌 취향 기반 커뮤니티 지향.
        </p>
      </div>
    </div>
...
<section class="ow-section" style="border-bottom:none">
  <div class="container">
    ...
    <div class="callout-green">
      ...
      서비스가 나를 착취하지 않을 것"이라는 신뢰의 욕구가 깔려 있다. 협동조합 형태 자체가 이 신뢰를
      만드는 구조적 자산이다.
    </div>
  </div>
</section>
